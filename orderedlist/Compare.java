...
public class Compare {
	...
	public static void functionTest() {
		...
		AVLCode.AVL<Integer, Integer> avl = new AVLCode.AVL<>();
		SBTCode.SBTTreeMap<Integer, Integer> sbt = new SBTCode.SBTTreeMap<>();
		SkipListCode.SkipList<Integer, Integer> skip = new SkipListCode.SkipList<>();
		int maxK = 500;
		int maxV = 50000;
	...
	public static void performanceTest() {
		...
		AVLCode.AVL<Integer, Integer> avl = new AVLCode.AVL<>();
		SBTCode.SBTTreeMap<Integer, Integer> sbt = new SBTCode.SBTTreeMap<>();
		SkipListCode.SkipList<Integer, Integer> skip = new SkipListCode.SkipList<>();		long start;
		long end;
		int max = 1000000;
		treeMap = new TreeMap<>();
//		avl = new AVLTreeMap<>();
